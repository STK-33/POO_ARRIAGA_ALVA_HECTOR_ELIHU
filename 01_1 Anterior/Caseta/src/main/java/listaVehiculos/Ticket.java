...
import listaVehiculos.registro;
...
public class Ticket extends javax.swing.JDialog implements Printable{
...
public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException
{
    ...
    public void mostrar(String Tipo_de_vehiculo, String Placa, int Numero_de_ejes, int total, int cuota)
    {
    ...
    public void mostrar()
    {
        this.Folio.setText(getCivFolio().toString());
