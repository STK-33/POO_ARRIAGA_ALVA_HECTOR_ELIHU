...
public final class Preview extends javax.swing.JFrame {
    ...
    void pasaDatos() {
        ...
        Ticket.jLabeTotal.setText("$"+jLabelTotalPago.getText());
        Ticket.jLabeEfectivoRecibido.setText("$"+jTextFieldEfectivoRecibido.getText());
    ...
    private void initComponents() {
        ...
        jButton1.setFont(new java.awt.Font("Ubuntu Condensed", 0, 14)); 
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nic/imgs/buy.png"))); 
        ...
        jButton2.setFont(new java.awt.Font("Ubuntu Condensed", 0, 14)); 
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nic/imgs/back.png"))); 
        ...
        jLabel2.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        jLabel2.setText("Pelicula ");

        jLabel3.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        jLabel3.setText("Sala");

        jLabel4.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        jLabel4.setText("Hora");

        jLabelSala.setBackground(new java.awt.Color(0, 204, 51));

        jLabel5.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        ...
        jLabel6.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        jLabel6.setText("Cantidad de boletos (niños)");

        jLabel7.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        jLabel7.setText("Total Adultos");

        jLabel8.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        jLabel8.setText("Total Niños");

        jLabel9.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        ...
        jLabel10.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        jLabel10.setText("Nombre vendedor: ");

        jTextFieldNombreVendedor.setEditable(false);
        jTextFieldNombreVendedor.setFont(new java.awt.Font("Ubuntu Condensed", 0, 14)); 
        jTextFieldNombreVendedor.setText("STK");

        jLabel11.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        jLabel11.setText("Cine DeltaStk");

        jLabel12.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        jLabel12.setText("Visitando:");

        jLabel13.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        jLabel13.setText("Efectivo recibido:");

        jLabel14.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/nic/imgs/click.png"))); 
        ...
        jLabel16.setFont(new java.awt.Font("Ubuntu Condensed", 0, 18)); 
        jLabel16.setText("CIne Delta-STk.com.mx");
