...
public class Administrador extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        SEMANAL = new javax.swing.JButton();
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 30, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 510, 170));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 310, 70, -1));

        lblced2.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        lblced2.setText("Total:");
        getContentPane().add(lblced2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 530, -1, 20));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 500, -1, -1));

        lblced3.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        lblced3.setText("Subtotal:");
        getContentPane().add(lblced3, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 440, -1, 20));

        lblced4.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        lblced4.setText("Descuento:");
        getContentPane().add(lblced4, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 470, -1, 20));

        lblced5.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        lblced5.setText("IVA:");
        getContentPane().add(lblced5, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 500, -1, 20));
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, 350, 40));
        getContentPane().add(txtsubtotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 440, 60, -1));
        getContentPane().add(textDesc, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 470, 60, -1));
        getContentPane().add(text_iva, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 500, 60, -1));
        getContentPane().add(text_total, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 530, 60, -1));
        ...
        getContentPane().add(btnCortedeCaja, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 500, -1, 40));
        ...
        getContentPane().add(DIARIO, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, -1, -1));
        ...
        getContentPane().add(SEMANAL, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 90, -1, -1));
        ...
        getContentPane().add(MENSUAL, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 90, -1, -1));

        jLabel3.setFont(new java.awt.Font("Verdana", 3, 12)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("REPORTES");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 70, 90, -1));
...
//cierra el documento
    ...
    private void DIARIOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DIARIOActionPerformed
        ...
        try {
            ...
            document.add(new Paragraph("---------------------------------------------------------------------"));
            document.add(new Paragraph("| REPORTE DIARIO-CASETA  MEXICO <--->PUEBLA |"));
            document.add(new Paragraph("---------------------------------------------------------------------"));
            document.add(new Paragraph("Numero de Reporte Diario : " + txtNumFact.getText()));
            document.add(new Paragraph("Placas : " + text_nomCli.getText() + " " + " " + text_ruc_prov.getText()));
            document.add(new Paragraph("  " + text_dir.getText()));
            document.add(new Paragraph("Fecha del Reporte: [ " + textDate.getText() + " ]  "));
    ...
    //cierra el documento
    document.close();
    JOptionPane.showMessageDialog(null, "Reporte Diario Listo");
    ...
    private void SEMANALActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SEMANALActionPerformed
       Document document = new Document(PageSize.A4, 35, 30, 50, 50);
        ...
        try {
            ...
            document.add(new Paragraph("---------------------------------------------------------------------"));
            document.add(new Paragraph("| REPORTE SEMANAL-CASETA  MEXICO <--->PUEBLA |"));
            document.add(new Paragraph("---------------------------------------------------------------------"));
            document.add(new Paragraph("Numero de Reporte Semanal : " + txtNumFact.getText()));
            document.add(new Paragraph("Placas : " + text_nomCli.getText() + " " + " " + text_ruc_prov.getText()));
            document.add(new Paragraph("  " + text_dir.getText()));
            document.add(new Paragraph("Fecha del Reporte: [ " + textDate.getText() + " ]  "));
    ...
    //cierra el documento
    document.close();
    JOptionPane.showMessageDialog(null, "Reporte Semanal Listo");
    ...
    private void MENSUALActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MENSUALActionPerformed
       Document document = new Document(PageSize.A4, 35, 30, 50, 50);
        ...
        try {
            ...
            document.add(new Paragraph("---------------------------------------------------------------------"));
            document.add(new Paragraph("| REPORTE MENSUAL-CASETA  MEXICO <--->PUEBLA |"));
            document.add(new Paragraph("---------------------------------------------------------------------"));
            document.add(new Paragraph("Numero de Reporte Mensual : " + txtNumFact.getText()));
            document.add(new Paragraph("Placas : " + text_nomCli.getText() + " " + " " + text_ruc_prov.getText()));
            document.add(new Paragraph("  " + text_dir.getText()));
            document.add(new Paragraph("Fecha del Reporte: [ " + textDate.getText() + " ]  "));
    ...
    //cierra el documento
    document.close();
    JOptionPane.showMessageDialog(null, "Reporte Mensual Listo");
    ...
    private javax.swing.JButton SEMANAL;
